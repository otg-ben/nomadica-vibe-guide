...
export const tahoe: VibeGuide = {
  ...
  anchorExperiences: [
    ...
    },
    {
      ...
      description:
        'One of the original trans-Sierra emigrant roads, Henness Pass carried hundreds of thousands of gold rush migrants and freight wagons between 1850 and the railroad era. Starting in Camptonville on Hwy 49, the route climbs east through the Yuba River watershed on a mix of paved and well-graded dirt roads, crossing the Sierra crest and dropping toward Sierraville. AWD crossovers and vans can handle most of it. The payoff is a 70-mile corridor through dense forest, river canyons, and high meadows with almost no traffic. Add 2 hours from Camptonville to Sierraville.',
      alert: { type: 'warning', text: 'The upper crossing closes in winter. Check road conditions at the Nevada County or Sierra County ranger districts before attempting in early season.' },
    ...
    },
    {
      ...
      description:
        'Bowman Lake sits in a granite basin north of Hwy 20 and serves as the anchor for one of the least-crowded clusters of high-country lakes in the northern Sierra. The approach on Bowman Lake Road is rocky enough to filter out anything without decent clearance. Beyond the main lake, a network of short spurs reaches Faucherie Lake, Sawmill Lake, Carr Lake, and Feeley Lake. Grouse Ridge Road climbs the ridgeline above for sweeping views back toward the Buttes. Plan to stay multiple nights — the dispersed sites along the north shore of Bowman are among the best in the forest.',
      alert: { type: 'warning', text: 'Bowman Lake Road requires high clearance. AWD crossovers and low-clearance vans should not attempt the upper section.' },
      placeId: 'bowman-lake',
    },
    {
      id: 'poker-flat-ohv',
      ...
      seasons: { spring: 'Variable', summer: 'Prime', fall: 'Good', winter: 'Not recommended' },
      description:
        'The Poker Flat area north of Downieville gives stock 4x4 trucks a genuine backcountry route without the commitment of a technical trail. Forest roads climb out of the North Yuba canyon through pine and fir, crossing ridgelines with views down into the Feather River country. The historic Poker Flat is one of the more evocative gold rush sites in Sierra County — a scattering of stone foundations and placer tailings in a narrow canyon that Bret Harte made famous in his 1869 short story. Out-and-back from Downieville or connect north toward La Porte for a longer loop.',
      alert: { type: 'warning', text: 'Road conditions vary by season. Confirm access at the Downieville Ranger District before heading out in early summer.' },
