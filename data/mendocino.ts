...
export const mendocino: VibeGuide = {
  ...
  overview: [
    "Mendocino National Forest holds a distinction no other California national forest can claim: it is the only one not crossed by a paved road or highway. That single fact shapes everything about the experience here. You won't drift through on the way to somewhere else. You have to mean it. That intention is exactly what keeps the crowds away and the solitude intact.",
    "The landscape shifts as you gain elevation. At the lower edges, the forest opens into blue oak savanna and rolling grass hills, golden in summer, green after the winter rains. Climb higher and the oaks give way to ponderosa pine, then mixed conifer (Douglas fir, white fir, black oak), the air cooling noticeably as the ridges come into view. The upper forest has the feel of true backcountry: wide skies, long views, and the kind of quiet you don't find within two hours of San Francisco.",
    "This is a soft-roader's forest. More than 98% of the roads are graded dirt and gravel, accessible to most vehicles without lockers or skid plates. If you're just getting into overlanding, Mendocino is one of the best places in California to find your footing. The roads are forgiving, the forest is expansive, and you can explore for days without running out of new ground.",
    "Lake Pillsbury anchors the social heart of the forest, the first place most people head, with camping right on the water and no reservation required. The Eel River corridor below Scott Dam is popular for summer swimming and hanging out on the water. The OHV network is one of the largest in Northern California. Ukiah and Willits are your best supply stops coming in from the west. Covelo, tucked into Round Valley on the eastern edge, is the quieter gateway, a small ranching town with deep ties to the land and to the Wailaki and Yuki peoples who have called this valley home for thousands of years.",
  ],
  kbyg: [
